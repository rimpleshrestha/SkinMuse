...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  late Future<ProductRepository> _repositoryFuture;

  @override
  void initState() {
    super.initState();
    _repositoryFuture = ProductRepository.create();
  }
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ProductRepository>(
      ...
      builder: (context, snapshot) {
        ...
        return BlocProvider(
          create: (_) => ProductListBloc(repository)..add(LoadSavedProducts()),
          child: Scaffold(
            appBar: AppBar(
